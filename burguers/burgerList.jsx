...
function BurgerList({ addToCart }) {
    return (
        ...
        {burgers.map((burger) => (
            <div className="flex items-center gap-5 md:font-mono bg-white min-w-70 max-h-80 flex-row rounded-xl my-4 shadow-sm"
             key={burger.id}>
                <div>
                ...
                <button className="flex max-h-8 bg-black py-1 px-4 rounded-2xl cursor-pointer text-white shadow-2xl transition duration-500 ease-in-out hover:bg-gray-300 hover:scale-120 hover:text-black " 
